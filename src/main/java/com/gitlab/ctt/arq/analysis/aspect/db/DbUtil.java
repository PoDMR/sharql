...
public class DbUtil {
	...
	public Map<String, String> typemap(String tableName) {
		Query<Map<String, Object>> query = h.createQuery(SqlUtil.typemap(tableName));
		List<Map<String, Object>> rows = queryToList(query);
		Map<String, String> result = new LinkedHashMap<>();
		for (Map<String, Object> row : rows) {
			Object name = row.get("column_name");
			Object type = row.get("data_type");
			result.put(String.valueOf(name), String.valueOf(type));
		}
		return result;
	}
	...
	public int insertRecord(String tableName, QueryRecord record) {
		return h.insert(SqlUtil.insertRecord(tableName, record, excludes));
	}
	...
	public int insertObject(String tableName, Object object) {
		return h.insert(SqlUtil.insertObject(tableName, object, excludes));
	}
